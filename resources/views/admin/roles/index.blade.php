    ...
    <div class="min-h-screen px-4 py-8 bg-zinc-50 dark:bg-zinc-800 transition-all">
        <div class="max-w-6xl mx-auto">
            <div class="flex justify-between items-center mb-6">
                <h1 class="text-2xl font-bold text-zinc-800 dark:text-white">Gestión de Roles</h1>
                @role('admin')
                                    ...
                                    <div class="flex justify-center gap-2">
                                        ...
                                        @if ($rol->usuarios_count == 0 && $rol->nombre !== 'admin')
                                            <form action="{{ route('roles.destroy', $rol) }}" method="POST"
                                                ...
                                                @method('DELETE')
                                                <button type="submit"
                                                    class="inline-flex items-center justify-center w-8 h-8 rounded-lg bg-red-500 hover:bg-red-600 text-white transition-colors duration-200 title="Eliminar"
