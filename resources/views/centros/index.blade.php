        ...
        <div class="max-w-6xl mx-auto">
            <div class="flex justify-between items-center mb-6">
                ...
                <a href="{{ route('centros.create') }}">
                    <button type="button"
                        class="bg-[#00618E] text-zinc-900 dark:text-white font-semibold px-4 py-2 rounded-lg hover:bg-[#004a6b] transition flex items-center gap-2">
                    ...
                    <tbody>
                        @foreach ($centros as $centro)
                            <tr class="{{ $tableRowClass }}">
                                <td class="p-3 text-zinc-900 dark:text-zinc-100 font-medium">{{ $centro->name }}</td>
