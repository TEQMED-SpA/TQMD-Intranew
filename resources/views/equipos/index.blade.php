            <x-layouts.app :title="'Equipos'">
                <div class="max-w-7xl mx-auto px-4 py-8">
                    ...
                    {{-- Filtros --}}
                    <form method="GET"
                        class="grid md:grid-cols-3 lg:grid-cols-7 gap-4 mb-6 bg-white dark:bg-zinc-900 p-4 rounded-lg shadow">
                            ...
                            <select name="estado"
                               ...
                               bg-white dark:bg-zinc-800 text-zinc-900 dark:text-white focus:ring-2 focus:ring-blue-500">
                                ...
                                @foreach (['Operativo', 'En observacion', 'Fuera de servicio', 'Baja'] as $e)
                                    <option value="{{ $e }}" @selected(request('estado') === $e)>{{ $e }}
                                    </option>
                                @endforeach
                            </select>
                        </div>
                            ...
                            <select name="tipo_mantencion"
                               ...
                               bg-white dark:bg-zinc-800 text-zinc-900 dark:text-white focus:ring-2 focus:ring-blue-500">
                                ...
                                @foreach (['T1', 'T2', 'T3'] as $t)
                                    <option value="{{ $t }}" @selected(request('tipo_mantencion') == $t)>
                                        {{ $t }}</option>
                                @endforeach
                            </select>
                        </div>
                        ...
                        <div class="col-span-3 lg:col-span-1">
                            <label class="block text-sm mb-1 text-zinc-700 dark:text-zinc-300">Tipo de equipo</label>
