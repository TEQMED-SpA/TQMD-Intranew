        ...
        <div class="space-y-2">
            ...
            <div
                ...
                <p class="text-xs text-zinc-600 dark:text-zinc-300 mb-2">
                    La firma del técnico es obligatoria. Dibuja con el mouse o lápiz sobre el área.
                </p>
                <canvas id="signature-pad-preventivo"
                ...
                <div class="mt-3 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3">
                    <button type="button" id="clear-signature-preventivo"
                    ...
                    <p class="text-[11px] text-zinc-500 dark:text-zinc-400" id="firma-help-preventivo">
                        Dibuja tu firma en el área de arriba.
                    </p>
                </div>
            </div>
            <input type="hidden" name="firma_tecnico" id="firma-input-preventivo">
            @error('firma_tecnico')
                <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
            @enderror
        </div>
