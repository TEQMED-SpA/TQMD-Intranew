                ...
                <table class="w-full table-auto text-left text-sm">
                    <thead>
                        <tr class="bg-white dark:bg-zinc-700">
                            ...
                            <th class="p-3 text-zinc-700 dark:text-white font-semibold">Email</th>
                            <th class="p-3 text-zinc-700 dark:text-white font-semibold">Rol</th>
                                ...
                                <td class="p-3 text-center">
                                    <div class="flex items-center justify-center gap-2">
                                        ...
                                        <form action="{{ route('users.destroy', $user) }}" method="POST"
                                            style="display:inline;" onsubmit="return confirm('¿Eliminar usuario?');">
                                            @csrf @method('DELETE')
                                            <button type="submit"
